! function (e, t) {
    ...
    try {
        ...
        sd._t = sd._t || 1 * new Date, sd.has_load_sdk = !0, "object" != typeof JSON && (JSON = {}),
            function () {
                "use strict";
                    ...
                    switch (c && "object" == typeof c && "function" == typeof c.toJSON && (c = c.toJSON(e)), "function" == typeof rep && (c = rep.call(t, e, c)), typeof c) {
                        ...
                        case "object":
                            ...
                            if (rep && "object" == typeof rep)
                                for (i = rep.length, r = 0; r < i; r += 1) "string" == typeof rep[r] && (n = rep[r], s = str(n, c), s && a.push(quote(n) + (gap ? ": " : ":") + s));
                            else
                                for (n in c) Object.prototype.hasOwnProperty.call(c, n) && (s = str(n, c), s && a.push(quote(n) + (gap ? ": " : ":") + s));
                            return s = 0 === a.length ? "{}" : gap ? "{\n" + gap + a.join(",\n" + gap) + "\n" + o + "}" : "{" + a.join(",") + "}", gap = o, s
                    }
                }
                var rx_one = /^[\],:{}\s]*$/,
                ...
                "function" != typeof JSON.stringify && (meta = {
                    ...
                    function walk(e, t) {
                        ...
                        if (s && "object" == typeof s)
                            for (r in s) Object.prototype.hasOwnProperty.call(s, r) && (n = walk(s, r), void 0 !== n ? s[r] = n : delete s[r]);
        ...
        logger.info = function () {
            ...
            function () {
                var e = (FuncProto.bind, ArrayProto.forEach),
                    t = (ArrayProto.indexOf, Array.isArray),
                    r = {},
                    n = _.each = function (t, n, s) {
                        if (null == t) return !1;
                        if (e && t.forEach === e) t.forEach(n, s);
                        else if (t.length === +t.length) {
                            for (var i = 0, a = t.length; i < a; i++)
                                if (i in t && n.call(s, t[i], i, t) === r) return !1
                        } else
                            for (var o in t)
                                if (hasOwnProperty.call(t, o) && n.call(s, t[o], o, t) === r) return !1
                    };
                ...
                var t, r, n, s, i, a, o, c, u = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
                    l = 0,
                    d = 0,
                    p = "",
                    f = [];
                ...
                function n(e, r) {
                    for (var n = e.charAt(0), s = r.split("&"), i = [], a = {}, o = [], c = e.substring(1), u = 0, l = s.length; u < l; u++)
                        if (i = s[u].match(/(.*?)=(.*)/), i || (i = [s[u], s[u], ""]), "" !== i[1].replace(/\s/g, "")) {
                ...
                return function (t, s) {
                    ...
                    if (t = t.toString(), i = s.match(/^mailto:([^\/].+)/)) a.protocol = "mailto", a.email = i[1];
                    else {
                ...
                if (sd.para.is_debug)
                    if (_.isString(e)) sd.registerPage({
                        _jssdk_debug_info: e
                    });
                    else {
        ...
        sd.sendState = sendState, sendState.queue = _.autoExeQueue(), sendState.requestData = null, sendState.getSendCall = function (e, t, r) {
            ...
            if (e = JSON.stringify(e), logger.info(n), this.requestData = {
                ...
                }, n))) ? "function" == typeof r && r() : this.prepareServerUrl() : (SensorsData_APP_JS_Bridge.sensorsdata_track(JSON.stringify(_.extend({
                    server_url: sd.para.server_url
                }, n))), "function" == typeof r && r());
                else if (!/sensors-verify/.test(navigator.userAgent) && !/sa-sdk-ios/.test(navigator.userAgent) || window.MSStream) sd.para.use_app_track === !0 && this.prepareServerUrl();
            else {
                var s = null;
                if (/sensors-verify/.test(navigator.userAgent)) {
                    ...
                    if (i && i[0] && "string" == typeof i[1] && 2 === i[1].split("?").length) {
                        ...
                        a && a === i[0] && o && o === i[1] ? (s = document.createElement("iframe"), s.setAttribute("src", "sensorsanalytics://trackEvent?event=" + encodeURIComponent(JSON.stringify(_.extend({
                            server_url: sd.para.server_url
                        }, n)))), document.documentElement.appendChild(s), s.parentNode.removeChild(s), s = null, "function" == typeof r && r()) : this.prepareServerUrl()
                    }
                } else s = document.createElement("iframe"), s.setAttribute("src", "sensorsanalytics://trackEvent?event=" + encodeURIComponent(JSON.stringify(_.extend({
                    server_url: sd.para.server_url
                }, n)))), document.documentElement.appendChild(s), s.parentNode.removeChild(s), s = null, "function" == typeof r && r()
        ...
        var heatmap = {
            getDomIndex: function (e) {
                ...
                for (var t = 0, r = e.tagName, n = e.parentNode.children, s = 0; s < n.length; s++)
                    if (n[s].tagName === r) {
                        if (e === n[s]) return t;
                        t++
                    } return -1
            ...
            initHeatmap: function () {
                ...
                return !(!_.isObject(sd.para.heatmap) || "default" !== sd.para.heatmap.clickmap) && (!(_.isFunction(sd.para.heatmap.collect_url) && !sd.para.heatmap.collect_url()) && ("all" === sd.para.heatmap.collect_elements ? sd.para.heatmap.collect_elements = "all" : sd.para.heatmap.collect_elements = "interact", void("all" === sd.para.heatmap.collect_elements ? _.addEvent(document, "click", function (t) {
                    ...
                    if (!n || !n.parentNode || !n.parentNode.children) return !1;
                    var i = n.parentNode;
                    if ("a" === s || "button" === s || "input" === s || "textarea" === s) e.start(r, n, s);
                    else if ("button" === i.tagName.toLowerCase() || "a" === i.tagName.toLowerCase()) e.start(r, i, n.parentNode.tagName.toLowerCase());
                    else if ("area" === s && "map" === i.tagName.toLowerCase() && _.ry(i).prev().tagName && "img" === _.ry(i).prev().tagName.toLowerCase()) e.start(r, _.ry(i).prev(), _.ry(i).prev().tagName.toLowerCase());
                    else {
